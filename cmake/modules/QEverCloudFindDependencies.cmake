if(_QEVERCLOUD_USE_QT6)
  ...
  if(BUILD_WITH_OAUTH_SUPPORT AND NOT QEVERCLOUD_USE_SYSTEM_BROWSER)
    ...
    if (QEVERCLOUD_USE_SYSTEM_BROWSER)
      if(BUILD_TRANSLATIONS)
        find_package(Qt6 6.0.0 COMPONENTS Core Gui LinguistTools Network Widgets ${QEVERCLOUD_FIND_QT_ARGS})
      else()
        find_package(Qt6 6.0.0 COMPONENTS Core Gui LinguistTools Network Widgets ${QEVERCLOUD_FIND_QT_ARGS})
      endif()
    else()
  ...
  if(BUILD_WITH_OAUTH_SUPPORT AND NOT QEVERCLOUD_USE_SYSTEM_BROWSER)
    ...
    if (QEVERCLOUD_USE_SYSTEM_BROWSER)
      if(BUILD_TRANSLATIONS)
        find_package(Qt5 5.10.0 COMPONENTS Core LinguistTools Network Widgets ${QEVERCLOUD_FIND_QT_ARGS})
      else()
        find_package(Qt5 5.10.0 COMPONENTS Core Network Widgets ${QEVERCLOUD_FIND_QT_ARGS})
      endif()
    else()
      if(BUILD_TRANSLATIONS)
