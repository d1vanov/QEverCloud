...
#ifndef QEVERCLOUD_GENERATED_PUBLISHINGIMPL_H
#define QEVERCLOUD_GENERATED_PUBLISHINGIMPL_H
...
public:
    ...
    [[nodiscard]] bool operator==(const Publishing::Impl & other) const noexcept;
    [[nodiscard]] bool operator!=(const Publishing::Impl & other) const noexcept;
...
#endif // QEVERCLOUD_GENERATED_PUBLISHINGIMPL_H
