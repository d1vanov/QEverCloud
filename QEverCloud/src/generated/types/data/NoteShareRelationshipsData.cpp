...
#include "NoteShareRelationshipsData.h"

#include <QTextStream>

namespace qevercloud {

bool NoteShareRelationships::NoteShareRelationshipsData::operator==(
    const NoteShareRelationshipsData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void NoteShareRelationships::NoteShareRelationshipsData::print(QTextStream & strm) const
{
