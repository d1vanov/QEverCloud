...
#include "NotebookRecipientSettingsData.h"

#include <QTextStream>

namespace qevercloud {

bool NotebookRecipientSettings::NotebookRecipientSettingsData::operator==(
    const NotebookRecipientSettingsData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void NotebookRecipientSettings::NotebookRecipientSettingsData::print(QTextStream & strm) const
{
