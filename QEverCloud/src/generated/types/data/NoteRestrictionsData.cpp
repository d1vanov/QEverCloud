...
bool NoteRestrictions::NoteRestrictionsData::operator==(
    const NoteRestrictionsData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void NoteRestrictions::NoteRestrictionsData::print(QTextStream & strm) const
{
