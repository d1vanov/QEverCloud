...
bool SyncChunkFilter::SyncChunkFilterData::operator==(
    const SyncChunkFilterData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void SyncChunkFilter::SyncChunkFilterData::print(QTextStream & strm) const
{
