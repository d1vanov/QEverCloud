...
#include "BusinessUserInfoData.h"

#include <QTextStream>

namespace qevercloud {

bool BusinessUserInfo::BusinessUserInfoData::operator==(
    const BusinessUserInfoData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void BusinessUserInfo::BusinessUserInfoData::print(QTextStream & strm) const
{
