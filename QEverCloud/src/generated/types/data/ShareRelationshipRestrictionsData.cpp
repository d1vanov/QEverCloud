...
bool ShareRelationshipRestrictions::ShareRelationshipRestrictionsData::operator==(
    const ShareRelationshipRestrictionsData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void ShareRelationshipRestrictions::ShareRelationshipRestrictionsData::print(QTextStream & strm) const
{
