...
#include "NoteMemberShareRelationshipData.h"

#include <QTextStream>

namespace qevercloud {

bool NoteMemberShareRelationship::NoteMemberShareRelationshipData::operator==(
    const NoteMemberShareRelationshipData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void NoteMemberShareRelationship::NoteMemberShareRelationshipData::print(QTextStream & strm) const
{
