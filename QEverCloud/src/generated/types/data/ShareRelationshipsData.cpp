...
bool ShareRelationships::ShareRelationshipsData::operator==(
    const ShareRelationshipsData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void ShareRelationships::ShareRelationshipsData::print(QTextStream & strm) const
{
