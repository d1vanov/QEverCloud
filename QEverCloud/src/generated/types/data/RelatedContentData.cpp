...
bool RelatedContent::RelatedContentData::operator==(
    const RelatedContentData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void RelatedContent::RelatedContentData::print(QTextStream & strm) const
{
    strm << "RelatedContent: {\n";
