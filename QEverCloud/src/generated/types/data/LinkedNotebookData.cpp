...
bool LinkedNotebook::LinkedNotebookData::operator==(
    const LinkedNotebookData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void LinkedNotebook::LinkedNotebookData::print(QTextStream & strm) const
{
    strm << "LinkedNotebook: {\n";
