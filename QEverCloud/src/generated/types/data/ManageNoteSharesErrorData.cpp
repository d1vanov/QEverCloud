...
bool ManageNoteSharesError::ManageNoteSharesErrorData::operator==(
    const ManageNoteSharesErrorData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void ManageNoteSharesError::ManageNoteSharesErrorData::print(QTextStream & strm) const
{
