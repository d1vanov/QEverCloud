...
#include "NoteLimitsData.h"

#include <QTextStream>

namespace qevercloud {

bool NoteLimits::NoteLimitsData::operator==(
    const NoteLimitsData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void NoteLimits::NoteLimitsData::print(QTextStream & strm) const
{
    strm << "NoteLimits: {\n";
