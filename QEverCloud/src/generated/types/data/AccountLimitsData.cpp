...
bool AccountLimits::AccountLimitsData::operator==(
    const AccountLimitsData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void AccountLimits::AccountLimitsData::print(QTextStream & strm) const
{
    strm << "AccountLimits: {\n";
