...
bool NoteAttributes::NoteAttributesData::operator==(
    const NoteAttributesData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void NoteAttributes::NoteAttributesData::print(QTextStream & strm) const
{
    strm << "NoteAttributes: {\n";
