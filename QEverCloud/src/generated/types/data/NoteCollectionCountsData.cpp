...
bool NoteCollectionCounts::NoteCollectionCountsData::operator==(
    const NoteCollectionCountsData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void NoteCollectionCounts::NoteCollectionCountsData::print(QTextStream & strm) const
{
