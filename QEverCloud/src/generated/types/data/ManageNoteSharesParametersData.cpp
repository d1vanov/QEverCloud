...
bool ManageNoteSharesParameters::ManageNoteSharesParametersData::operator==(
    const ManageNoteSharesParametersData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void ManageNoteSharesParameters::ManageNoteSharesParametersData::print(QTextStream & strm) const
{
