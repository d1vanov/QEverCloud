...
#include "NotesMetadataResultSpecData.h"

#include <QTextStream>

namespace qevercloud {

bool NotesMetadataResultSpec::NotesMetadataResultSpecData::operator==(
    const NotesMetadataResultSpecData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void NotesMetadataResultSpec::NotesMetadataResultSpecData::print(QTextStream & strm) const
{
