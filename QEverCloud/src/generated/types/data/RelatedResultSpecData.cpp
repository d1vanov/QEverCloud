...
#include "RelatedResultSpecData.h"

#include <QTextStream>

namespace qevercloud {

bool RelatedResultSpec::RelatedResultSpecData::operator==(
    const RelatedResultSpecData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void RelatedResultSpec::RelatedResultSpecData::print(QTextStream & strm) const
{
