...
bool MemberShareRelationship::MemberShareRelationshipData::operator==(
    const MemberShareRelationshipData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void MemberShareRelationship::MemberShareRelationshipData::print(QTextStream & strm) const
{
