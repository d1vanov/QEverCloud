...
#ifndef QEVERCLOUD_GENERATED_USERATTRIBUTESDATA_H
#define QEVERCLOUD_GENERATED_USERATTRIBUTESDATA_H
...
class Q_DECL_HIDDEN UserAttributes::UserAttributesData final:
    public QSharedData,
    public Printable
{
public:
    UserAttributesData() = default;
    UserAttributesData(const UserAttributesData & other) = default;
    UserAttributesData(UserAttributesData && other) noexcept = default;

    UserAttributesData & operator=(const UserAttributesData & other) = delete;
    UserAttributesData & operator=(UserAttributesData && other) = delete;

    ~UserAttributesData() noexcept override = default;

    [[nodiscard]] bool operator==(const UserAttributesData & other) const noexcept;
    [[nodiscard]] bool operator!=(const UserAttributesData & other) const noexcept;
...
#endif // QEVERCLOUD_GENERATED_USERATTRIBUTESDATA_H
