...
#include "InvitationShareRelationshipData.h"

#include <QTextStream>

namespace qevercloud {

bool InvitationShareRelationship::InvitationShareRelationshipData::operator==(
    const InvitationShareRelationshipData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void InvitationShareRelationship::InvitationShareRelationshipData::print(QTextStream & strm) const
{
