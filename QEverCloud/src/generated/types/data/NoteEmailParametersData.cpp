...
bool NoteEmailParameters::NoteEmailParametersData::operator==(
    const NoteEmailParametersData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void NoteEmailParameters::NoteEmailParametersData::print(QTextStream & strm) const
{
