...
#include "NoteResultSpecData.h"

#include <QTextStream>

namespace qevercloud {

bool NoteResultSpec::NoteResultSpecData::operator==(
    const NoteResultSpecData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void NoteResultSpec::NoteResultSpecData::print(QTextStream & strm) const
{
    strm << "NoteResultSpec: {\n";
