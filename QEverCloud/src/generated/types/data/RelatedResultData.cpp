...
bool RelatedResult::RelatedResultData::operator==(
    const RelatedResultData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void RelatedResult::RelatedResultData::print(QTextStream & strm) const
{
    strm << "RelatedResult: {\n";
