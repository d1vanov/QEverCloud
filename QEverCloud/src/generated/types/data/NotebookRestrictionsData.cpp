...
bool NotebookRestrictions::NotebookRestrictionsData::operator==(
    const NotebookRestrictionsData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void NotebookRestrictions::NotebookRestrictionsData::print(QTextStream & strm) const
{
