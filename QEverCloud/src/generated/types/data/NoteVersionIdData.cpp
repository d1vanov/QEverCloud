...
bool NoteVersionId::NoteVersionIdData::operator==(
    const NoteVersionIdData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void NoteVersionId::NoteVersionIdData::print(QTextStream & strm) const
{
    strm << "NoteVersionId: {\n";
