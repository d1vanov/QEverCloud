...
bool BusinessUserAttributes::BusinessUserAttributesData::operator==(
    const BusinessUserAttributesData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void BusinessUserAttributes::BusinessUserAttributesData::print(QTextStream & strm) const
{
