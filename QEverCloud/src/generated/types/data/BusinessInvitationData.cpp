...
bool BusinessInvitation::BusinessInvitationData::operator==(
    const BusinessInvitationData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void BusinessInvitation::BusinessInvitationData::print(QTextStream & strm) const
{
