...
bool NotebookDescriptor::NotebookDescriptorData::operator==(
    const NotebookDescriptorData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void NotebookDescriptor::NotebookDescriptorData::print(QTextStream & strm) const
{
