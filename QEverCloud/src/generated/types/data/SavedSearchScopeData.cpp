...
bool SavedSearchScope::SavedSearchScopeData::operator==(
    const SavedSearchScopeData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void SavedSearchScope::SavedSearchScopeData::print(QTextStream & strm) const
{
