...
bool AuthenticationResult::AuthenticationResultData::operator==(
    const AuthenticationResultData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void AuthenticationResult::AuthenticationResultData::print(QTextStream & strm) const
{
