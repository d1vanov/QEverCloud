...
#include "NoteMetadataData.h"

#include <QTextStream>

namespace qevercloud {

bool NoteMetadata::NoteMetadataData::operator==(
    const NoteMetadataData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void NoteMetadata::NoteMetadataData::print(QTextStream & strm) const
{
    strm << "NoteMetadata: {\n";
