...
bool BootstrapSettings::BootstrapSettingsData::operator==(
    const BootstrapSettingsData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void BootstrapSettings::BootstrapSettingsData::print(QTextStream & strm) const
{
