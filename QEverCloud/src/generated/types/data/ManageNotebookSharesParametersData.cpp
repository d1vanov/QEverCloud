...
#include "ManageNotebookSharesParametersData.h"

#include <QTextStream>

namespace qevercloud {

bool ManageNotebookSharesParameters::ManageNotebookSharesParametersData::operator==(
    const ManageNotebookSharesParametersData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void ManageNotebookSharesParameters::ManageNotebookSharesParametersData::print(QTextStream & strm) const
{
