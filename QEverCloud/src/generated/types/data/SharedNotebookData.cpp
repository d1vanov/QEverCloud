...
bool SharedNotebook::SharedNotebookData::operator==(
    const SharedNotebookData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void SharedNotebook::SharedNotebookData::print(QTextStream & strm) const
{
    strm << "SharedNotebook: {\n";
