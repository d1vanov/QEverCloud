...
#include "SharedNoteTemplateData.h"

#include <QTextStream>

namespace qevercloud {

bool SharedNoteTemplate::SharedNoteTemplateData::operator==(
    const SharedNoteTemplateData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void SharedNoteTemplate::SharedNoteTemplateData::print(QTextStream & strm) const
{
