...
#include "BusinessNotebookData.h"

#include <QTextStream>

namespace qevercloud {

bool BusinessNotebook::BusinessNotebookData::operator==(
    const BusinessNotebookData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void BusinessNotebook::BusinessNotebookData::print(QTextStream & strm) const
{
