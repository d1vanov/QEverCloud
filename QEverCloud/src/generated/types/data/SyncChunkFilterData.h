...
#ifndef QEVERCLOUD_GENERATED_SYNCCHUNKFILTERDATA_H
#define QEVERCLOUD_GENERATED_SYNCCHUNKFILTERDATA_H
...
class Q_DECL_HIDDEN SyncChunkFilter::SyncChunkFilterData final:
    public QSharedData,
    public Printable
{
public:
    SyncChunkFilterData() = default;
    SyncChunkFilterData(const SyncChunkFilterData & other) = default;
    SyncChunkFilterData(SyncChunkFilterData && other) noexcept = default;

    SyncChunkFilterData & operator=(const SyncChunkFilterData & other) = delete;
    SyncChunkFilterData & operator=(SyncChunkFilterData && other) = delete;

    ~SyncChunkFilterData() noexcept override = default;

    [[nodiscard]] bool operator==(const SyncChunkFilterData & other) const noexcept;
    [[nodiscard]] bool operator!=(const SyncChunkFilterData & other) const noexcept;
...
#endif // QEVERCLOUD_GENERATED_SYNCCHUNKFILTERDATA_H
