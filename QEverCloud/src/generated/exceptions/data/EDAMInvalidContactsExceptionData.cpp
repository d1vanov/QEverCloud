...
bool EDAMInvalidContactsException::EDAMInvalidContactsExceptionData::operator==(
    const EDAMInvalidContactsExceptionData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void EDAMInvalidContactsException::EDAMInvalidContactsExceptionData::print(QTextStream & strm) const
{
