...
bool EDAMSystemException::EDAMSystemExceptionData::operator==(
    const EDAMSystemExceptionData & other) const noexcept
{
    if (this == &other) {
        return true;
    }
...
void EDAMSystemException::EDAMSystemExceptionData::print(QTextStream & strm) const
{
