...
#ifndef QEVERCLOUD_GENERATED_NOTEINVITATIONSHARERELATIONSHIP_H
#define QEVERCLOUD_GENERATED_NOTEINVITATIONSHARERELATIONSHIP_H
...
public:
    ...
    */
    ...
    [[nodiscard]] bool operator==(const NoteInvitationShareRelationship & other) const noexcept;
    [[nodiscard]] bool operator!=(const NoteInvitationShareRelationship & other) const noexcept;
...
private:
    class NoteInvitationShareRelationshipData;
    QSharedDataPointer<NoteInvitationShareRelationshipData> d;
};
...
#endif // QEVERCLOUD_GENERATED_NOTEINVITATIONSHARERELATIONSHIP_H
