...
QJsonObject serializeToJson(const NotesMetadataList & value)
{
    QJsonObject object;
...
bool deserializeFromJson(const QJsonObject & object, NotesMetadataList & value)
{
