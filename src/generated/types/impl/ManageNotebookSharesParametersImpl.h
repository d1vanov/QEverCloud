...
#include <qevercloud/generated/types/ManageNotebookSharesParameters.h>
#include <QSharedData>
...
public:
    ...
    [[nodiscard]] bool operator==(const ManageNotebookSharesParameters::Impl & other) const noexcept;
    [[nodiscard]] bool operator!=(const ManageNotebookSharesParameters::Impl & other) const noexcept;
