...
#ifndef QEVERCLOUD_GENERATED_CONTACTIMPL_H
#define QEVERCLOUD_GENERATED_CONTACTIMPL_H
...
public:
    ...
    [[nodiscard]] bool operator==(const Contact::Impl & other) const noexcept;
    [[nodiscard]] bool operator!=(const Contact::Impl & other) const noexcept;
...
#endif // QEVERCLOUD_GENERATED_CONTACTIMPL_H
